...
\item
UC Berkeley Graduate Fellowship 2013 (full tuition with stipend)
\end{itemize}
\vspace{-2mm}
...
\begin{itemize}                                         \itemsep1pt
        \item \textit{Coursework}: Numerical Analysis, Optimization Theory, Applied Matrix Analysis,  Complex Analysis, Probability and Statistics
\end{itemize}
\vspace{-2mm}
