...
\begin{itemize}
\item 
\textit{Course work}: Learning and Optimization, Mathematical Programming, Supply Chain and Logistics Management,  Applied Statistic Processes,  Financial Engineering
\item
...
\begin{itemize}                                         \itemsep1pt
        \item \textit{Course work}: Numerical Analysis, Optimization Theory, Applied Matrix Analysis,  Complex Analysis, Probability and Statistics
\end{itemize}
\vspace{-2mm}
